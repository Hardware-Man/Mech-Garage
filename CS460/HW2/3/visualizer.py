...
import file_parse
from rrt import rrt, define_cspace
import sys
...
def visualize_trajectory(robot, obstacles, start, goal, iter_n):
    fig, ax = plt.subplots()
    plot_setup()
...
if __name__ == "__main__":
    ...
    if iter_n == 0:
        ...
        # successes = 0
        # for i in range(10): 
        #     successes+=visualize_trajectory(robot, obstacles, start, goal, iter_n)
        # print("Successes: ", successes)

        visualize_trajectory(robot, obstacles, start, goal, iter_n)
